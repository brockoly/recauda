...
<div id="btnCargaMasiva" onclick="ventanaModal('./view/dialog/cargaPaciente.php','','auto','auto','Carga de Paciente','modalCargaPaciente')"><img src="./include/img/csv.png" width="25" height="25"> Carga Masiva</div>
<br><br>
<center>
