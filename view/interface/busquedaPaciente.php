            ...
            <thead>
            	...
            	<?
					...
					<tr>
						...
						<td>
						<img name="btnEditar" title="Editar Nacionalidad" src="./include/img/Restaurar.png" onclick="mensajeUsuarioConProcedimiento('alertMensaje','Confirmar Acción','Atención, se procederá a RESTAURAR al paciente con identificación <?=$pacientesEli[$i]['Identificador']?>, ¿Desea continuar?','./controller/server/controlador_paciente.php','pac_id=<?=$pacientesEli[$i]['pac_id']?>&op=restaurarPaciente','view/interface/busquedaPaciente.php','','#contenidoCargado')" style="cursor: pointer;" style="cursor: pointer;')"/>
						&nbsp;&nbsp;&nbsp;
						</td>
					</tr>
        			<tr>
