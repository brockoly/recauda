...
$pdf->AddPage('L', 'A4');
//RECEPCION VARIABLE
if($_REQUEST['id_paciente']) $id_paciente = $_REQUEST['id_paciente'];
if($_REQUEST['cta_cte']) $cta_cte = $_REQUEST['cta_cte'];
...
require_once('../../Clases/Prestacion.inc'); $objPrestacion = new Prestacion;
require_once('../../Clases/Util.inc'); $objUtil = new Util;
require_once('../../Clases/pad.inc'); $objPad = new Pad;
require_once('../../Clases/Reporte.inc'); $objReporte = new Reporte;
require_once('../../Clases/Arqueo.inc'); $objArqueo = new Arqueo;
